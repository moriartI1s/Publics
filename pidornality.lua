...
if not Success then
	warn("\Sasun Library - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Sasun Library Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Sasun Library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Sasun Library"
