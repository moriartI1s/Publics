...
getgenv().AimPart = "Head" -- For R15 Games: {Head, Head, Head, Head} | For R6 Games: {Head, Head, Head}
getgenv().AimlockToggleKey = "Y" -- Toggles Aimbot On/Off 
getgenv().AimRadius = 75 -- How far away from someones character you want to lock on at
        ...
        if Key.UserInputType == Enum.UserInputType.MouseButton2 then 
            pcall(function()
                ...
                if Target ~= nil then 
                    ...
                    Notify("Pidornality", "Aimlock Target: "..tostring(AimlockTarget), "", 3)
                end
            end)
        end
